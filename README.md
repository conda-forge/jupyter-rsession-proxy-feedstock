...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyter-rsession-proxy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6725&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter-rsession-proxy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyter-rsession-proxy` can be installed with:

```
conda install jupyter-rsession-proxy
```

It is possible to list all of the versions of `jupyter-rsession-proxy` available on your platform with:
